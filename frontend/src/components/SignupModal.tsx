      ...
      <AnimatePresence>
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">가입 완료</h3>
    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-8 max-h-[90vh] overflow-y-auto"
        >
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <button onClick={onSwitchToLogin} className="text-gray-900 font-medium hover:underline">
              로그인
            </button>
          </div>
        </motion.div>
